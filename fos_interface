...
print("Current Version: FOS 1.69.5")
...
from matplotlib import __bibtex__, bivar_colormaps, color_sequences, colormaps, defaultParams, multivar_colormaps, rcParams, rcParamsDefault, rcParamsOrig
...
input("Now, you can press \"enter\" and boot up.\n")
